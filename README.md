> [!IMPORTANT]
> Rock'n Roller 0.4.0 and above source code move to [CagayakeGirls/itemscroller-neoforge](https://github.com/CagayakeGirls/itemscroller-neoforge).
...
Item Scroller unofficial (Neo)Forge port.
